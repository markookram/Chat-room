...
public static class ChatRoomEventsDataSeed
{
    ...
    private static ModelBuilder SeedEvents(this ModelBuilder builder)
    {
        ...
        ent.HasData(CreateChatEvent(1, EventType.ParticipantEntered, 1, "Mike on Sql", _roomId1).TweakDateOfBirth(startDateTime.AddHours(_counter++).AddMinutes(_counter++)));
        ent.HasData(CreateChatEvent(2, EventType.ParticipantEntered, 2, "Bob on Sql", _roomId1).TweakDateOfBirth(startDateTime.AddHours(_counter++).AddMinutes(_counter++)));
        ...
        ent.HasData(CreateChatEvent(5, EventType.ParticipantCommented, 1, "Mike on Sql", _roomId1, message: "Hi...").TweakDateOfBirth(startDateTime.AddHours(_counter++).AddMinutes(_counter++)));
        ent.HasData(CreateChatEvent(6, EventType.ParticipantCommented, 2, "Bob on Sql", _roomId1, message: "Same to you").TweakDateOfBirth(startDateTime.AddHours(_counter++).AddMinutes(_counter++)));
        ...
        ent.HasData(CreateChatEvent(16, EventType.ParticipantCommented, 1, "Mike on Sql", _roomId2, message: "Hi Alice, sorry for being late.").TweakDateOfBirth(startDateTime.AddHours(_counter++).AddMinutes(_counter++)));
        ent.HasData(CreateChatEvent(17, EventType.ParticipantCommented, 4, "Alice on Sql", _roomId2, message: "nw").TweakDateOfBirth(startDateTime.AddHours(_counter++).AddMinutes(_counter++)));
